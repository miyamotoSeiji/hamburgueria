        ...
        $this->Html->div('container',
            $this->Html->div('col-md-8 offset-md-2',
                $this->Html->tag('fieldset',
                    $this->Html->tag('legend', 'Cadastro de produto', array('class' => 'text-center')) .
                    ...
                    $this->Html->div('col', $this->Form->input('foto', array('label' => 'Foto do produto', 'class' => 'form-control', 'type' => 'file', 'style' => 'height:44px;'))) .
                ...
                $this->Html->tag('span',
                    $this->Form->button('Cadastrar', array('type' => 'submit', 'class' => 'btn btn-outline-success btn-lg')) . $this->Html->link('Voltar', '/produtos/', array('class' => 'btn btn-outline-primary btn-lg', 'style' => array('margin-left:5px;')))
